<template>
  <div style="text-align: center;margin: 0 50px">
    ...
    <el-row style="margin-top: 10px">
      <el-col :span="12" style="text-align: left"><el-checkbox v-model="loginForm.remember" label="记住我" size="small"/></el-col>
      <el-col :span="12" style="text-align: right"><el-link @click="router.push('/forget')" style="font-size: 12px">忘记密码</el-link></el-col>
    </el-row>
